...
return [
    ...
    'Max SR' => '最大SR',
        ...
        'Netcafe' => 'Netcafe',
        'Official Netcafe' => 'Official Netcafe',
        'Hunter Life Card' => 'Hunter Life Card',
        'Extra Card' => 'Extra Card',
    'Selection' => 'Selection',
    'Player selects one' => 'Player selects one',
    'Amount' => '数量',
    'Colors Table' => 'カラーコード',
    //Gacha Editor
    'Gacha Type' => 'ガチャタイプ',
    ...
    'URL Banner' => 'URLバナー',
    'URL Feature' => 'URL特徴',
    'URL Thumbnail' => 'URLサムネイル',
    'Wide' => 'ワイド',
    'Hidden' => '非表示',
    'Create Gacha Shop' => 'ガチャショップを作成',
    'Editing Gacha Shop' => 'ガチャショップの編集',
    'Entries' => 'エントリー',
    'Gacha ID' => 'Gacha ID',
    'Entry Type' => 'エントリータイプ',
    'Item Type' => 'アイテムタイプ',
